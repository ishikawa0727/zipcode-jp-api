...
export const ERROR_CODE = {
  ZIP_CODE_PROCESSING: {
    FILE_SAVING_FAILED: 'ZIP_CODE_PROCESSING/FILE_SAVING_FAILED',
    DIRECTORY_REMOVING_FAILED: 'ZIP_CODE_PROCESSING/DIRECTORY_REMOVING_FAILED',
    DIRECTORY_MAKING_FAILED: 'ZIP_CODE_PROCESSING/DIRECTORY_MAKING_FAILED',
    ZIP_CODE_MISMATCH: 'ZIP_CODE_PROCESSING/ZIP_CODE_MISMATCH'
  }
} as const
